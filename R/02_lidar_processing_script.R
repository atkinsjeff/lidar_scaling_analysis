...
library(raster)
# importing data
las.files <- list.files(path = "./data/source_data/", pattern = "GRSM",  full.names = TRUE)
...
#     filter(siteID == "osbs" & plotType == "tower") %>%
#     data.frame() -> grsm.pts
...
for (i in 1:length(las.files)) {
    ...
    process_lidar_file(las.files[i], "./results/GRSM/", res.list[j])
}

# 
# for (i in 1:length(grsm)) {
#         process_lidar_file(grsm[i], "./results/osbs/", 5)
# }
# 
# for (i in 1:length(grsm)) {
#     process_lidar_file(grsm[i], "./results/osbs/", 500)
# }
# 
# for (i in 1:length(grsm)) {
#     process_lidar_file(grsm[i], "./results/osbs/", 1000)
# }
# 
# for (j in seq_along(res.list)){
#     res = res.list[j]
#         for (i in 1:length(grsm)){
#         process_lidar_file(grsm[i], "./results/osbs/", res)
#         }
# }
...
# 5 meters
#### creatiing mosaics
grsm.10.list <- list.files(path = "./results/osbs/", pattern = c("_5.tif"), ignore.case = TRUE, full.names = TRUE)
...
# 
grsm.10 <- sampleRegular(rast.mosaic, size = 288, sp = T, xy = TRUE)
grsm.10$res = 5
grsm.10$siteID = "osbs"
...
# 10 meters
#### creatiing mosaics
grsm.10.list <- list.files(path = "./results/osbs/", pattern = "_10.tif", ignore.case = TRUE, full.names = TRUE)
...
# 25 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_25.tif", ignore.case = TRUE, full.names = TRUE)
...
# create a regular saple of points
# 
x <- sampleRegular(rast.mosaic, size = 288, sp = T, xy = TRUE)
x$res <-  25
x$siteID <- "osbs"
...
# 30 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_30.tif", ignore.case = TRUE, full.names = TRUE)
...
# 50 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_50.tif", ignore.case = TRUE, full.names = TRUE)
...
# 60 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_60.tif", ignore.case = TRUE, full.names = TRUE)
...
# 90 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_90.tif", ignore.case = TRUE, full.names = TRUE)
...
# 100 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_100.tif", ignore.case = TRUE, full.names = TRUE)
...
# 150 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_150.tif", ignore.case = TRUE, full.names = TRUE)
...
# 250 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_250.tif", ignore.case = TRUE, full.names = TRUE)
...
# 500 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_500.tif", ignore.case = TRUE, full.names = TRUE)
...
# create a regular saple of points
# 
x <- sampleRegular(rast.mosaic, size = 72, sp = T, xy = TRUE)
x$res <-  500
x$siteID <- "osbs"
...
# 1000 meters
#### creatiing mosaics
file.list <- list.files(path = "./results/osbs/", pattern = "_1000.tif", ignore.case = TRUE, full.names = TRUE)
...
# create a regular saple of points
# 
x <- sampleRegular(rast.mosaic, size = 18, sp = T, xy = TRUE)
x$res <-  1000
x$siteID <- "osbs"
...
#####
write.csv(grsm.metrics, "osbs_processed_metrics.csv")
